...
The second experiment was performed to answer the question whether or not adding temporal data into the source files would aid in the performance of the model. The translations generated by the temporal model got a BLEU-score of 2.85 and a TER score of 0.97. When compared to the baseline system this 
...
3. temporal bpe
4. bpe not being available with vocal and combined
5. encoding
